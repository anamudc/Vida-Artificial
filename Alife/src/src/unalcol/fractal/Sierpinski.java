...
*/
    public static void main( String[] args ){
      ...
      int k = 6; // Integer.parseInt(args[0]);
      int startAlpha = 30; // Integer.parseInt(args[1]);
      int finalAlpha = 20*k; // Integer.parseInt(args[2]);
      int deltaAlpha = 10; //Integer.parseInt(args[3]);
      boolean random_angle = false; // args[4].equals("true");
