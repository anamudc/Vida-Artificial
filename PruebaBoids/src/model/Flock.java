...
public class Flock {
    ...
    public Flock() {
        ...
        boids.add(new TestBoid(400, 100, "Red", new Image("images/nuevoRaton.png")));
        boids.add(new TestBoid(700, 100, "Green", new Image("images/boid-green.png")));
        boids.add(new TestBoid(250, 30, "Blue", new Image("images/boid-blue.png")));
